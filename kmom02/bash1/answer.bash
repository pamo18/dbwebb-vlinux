...
#
# 72ed8a1297610913151e1ba48b8b6e97
# vlinux
# bash1
# v1
# pamo18
...
# v4.0.0 (2019-03-05)
#
# Generated 2019-09-06 17:03:27 by dbwebb lab-utility v4.0.0 (2019-03-05).
...
ANSWER=$(find apache2/apache2.conf)
...
ANSWER=$(find apache2 -type d -maxdepth 1 -name "*conf*" | sort)
...
ANSWER=$(find apache2/sites-available/* apache2/mods-available/* -name "*ssl*.conf" -type f)
